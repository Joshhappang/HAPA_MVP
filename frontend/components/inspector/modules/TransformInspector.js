/* =========================================
   HAPA MINI FIGMA - TRANSFORM INSPECTOR CORE
   frontend/components/inspector/TransformInspector.js
========================================= */
...
export class TransformInspector {
    ...
    render() {
        ...
        wrapper.className = "hapa-transform-inspector";
        ...
        alignWrapper.className = "hapa-transform-align";

        const alignLabel = document.createElement("div");
        alignLabel.className = "transform-section-label";
        alignLabel.textContent = "Align";

        alignWrapper.appendChild(alignLabel);

        const alignRow = document.createElement("div");
        alignRow.className = "transform-align-row";
        ...
        alignButtons.forEach(btn => {
            ...
            b.className = "transform-align-btn";
